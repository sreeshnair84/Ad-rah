...
export default function DashboardLayout({
  ...
  const navigationMap = {
    ...
    'billing': { label: 'Billing', group: 'Billing & Payments' },
    'payouts': { label: 'Payouts', group: 'Billing & Payments' },
    'ad-slots': { label: 'Ad Slots', group: 'Ad Slot Management' },
    'bookings': { label: 'Bookings', group: 'Ad Slot Management' },
    'locations': { label: 'Locations', group: 'Ad Slot Management' },
    'campaigns': { label: 'Campaigns', group: 'Ad Slot Management' },
